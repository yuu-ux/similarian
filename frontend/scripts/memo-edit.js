...
window.setupMemoEdit = function() {
    ...
    saveButton.addEventListener('click', async () => {
        ...
        try {
            ...
            let response;
            if (memoId) {
                response = await fetch('https://rra5ztrdk7.us-west-2.awsapprunner.com/api/update', {
                    method: 'POST',
                    headers: {
                ...
                response = await fetch('https://rra5ztrdk7.us-west-2.awsapprunner.com/api/create', {
                    method: 'POST',
                    body: formData
                });
            }
